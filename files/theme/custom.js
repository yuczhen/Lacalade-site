(function () {
  ...
  localTheme.href = 'files/main_style.css?restore=7';
  ...
  repairStyle.textContent = [
    ...
    '.wsite-page-slots .main-wrap{background:linear-gradient(rgba(255,255,255,.5),rgba(255,255,255,.5)),url("https://cdn2.editmysite.com/images/editor/theme-background/stock/Meadow-Morning.jpg") center center/cover fixed no-repeat!important;}',
    '.wsite-page-slots .main-wrap .wsite-section{background:transparent!important;}',
    '.archive-gallery{max-width:960px;margin:0 auto 28px;}',
    '.archive-gallery-main{position:relative;display:flex;align-items:center;justify-content:center;min-height:360px;background:transparent;}',
    '.archive-gallery-main img{display:block;max-width:92%;max-height:650px;width:auto;height:auto;margin:auto;}',
    '.archive-gallery-arrow{position:absolute;top:50%;transform:translateY(-50%);border:0;background:rgba(0,0,0,.48);color:#fff;width:42px;height:42px;font-size:27px;line-height:42px;text-align:center;cursor:pointer;z-index:2;}',
